***********************************************************************
    Roland CAMM-1 DRIVER for Windows(R) 10 (64ビット版) 
***********************************************************************

最初にお読みください。インストールの手順が書かれています。
本書では、Windows 10 の基本的な操作方法についてすでにご理解いただいているものとして説明しています。
...
このドライバは、日本語 Windows 10 64ビット版 で動作する、当社製サインメーカーCAMM-1シリーズ用のドライバです。
...
※ 管理者権限を持ったユーザーでログオンしてください。
※ アンインストール対象のドライバーが[通常使うプリンターに設定(A)]されている場合は、設定を解除した上でアンインストールを実行して下さい。

1.  機器の電源を切り、コンピュータと機器間の接続ケーブルを外します。
2.  Windows を起動します。
3.  [スタート]をクリックします。
4.  [すべてのアプリ]-[Windowsシステムツール]-[コントロールパネル]をクリックします。
...
##### CorelDRAW 2017/X8 から出力するときの注意事項 #####
