***********************************************************************
   Roland CAMM-1 DRIVER for Windows(R) 10 64-bit
***********************************************************************
...
Copyright (C) 2016-2017 Roland DG Corporation
...
6.	The [User Account Control] appears, click [Yes].
...
*	Log on as a user with administrator rights.
*	If the target driver is set as default printer, please unset before uninstalling.

1.	Switch off the power to the machine, then detach the connector cable between the machine and the computer.
2.	Start Windows.
3.	Click [Start].
4.	Click [All apps]-[Windows System]-[ControlPanel].
...
11.	The [User Account Control] appears, click [Yes].
...
##### Important Notes When Performing Output from CorelDRAW 2017/X8 #####
